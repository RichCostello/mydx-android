...
//-------------------------------------------------------------------------------------------------
//    @name:      EncryptDecrypt
//    @purpose:   Responsible for Encrypt and Decrypt String
//    @category:  PHP Class
//    @author:    Greg E. Salivio 12/12/2014 started
//    @version:   1.0
...
//Module info Macros
define("UL_MODULE_NAME",            "Encrypt and Decrypt String");
...
class EncryptDecrypt
{
   ...
   var $skey   = "GsCdx122014ROCK!"; // you can change it
