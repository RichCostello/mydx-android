<?php
 error_reporting(0);
        include("includes/demo_sessions.php");
      //
 ...
 <!--    <link href="justified-nav.css" rel="stylesheet"> -->
  ...
  <div class="begintest">
   ...
   <div class="owl-carousel owl-theme owl-center owl-loaded loop">
             ...
             <div class="molli-text">Just flip to the <br> type of sample you want to test<br> to get started...</div>
</div>
...
<!-- modal message -->
 ...
 <p class="sharel text-center"><a href="demo_quicktest.php">Analyze with MyDx</a></p>
 <br>
